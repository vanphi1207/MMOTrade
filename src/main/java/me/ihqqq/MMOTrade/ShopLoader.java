...
public class ShopLoader {
                ...
                try {
                    ...
                    if (result == null) {
                        ...
                        if (ingredients.isEmpty()) {
                            ...
                            // Enable exact match to prevent MMOItems from matching vanilla items
    ...
    private static ItemStack parseItem(Object typeObj, Object idObj, Object amountObj, Object modelObj, MMOTrade plugin) {
        if (typeObj != null && idObj != null) {
            ...
            // Check if explicitly vanilla type
            if (type.equalsIgnoreCase("VANILLA")) {
                try {
                    ...
                    plugin.getLogger().warning("Could not parse vanilla material: " + id);
                }
                return null;
            }

            // Try MMOItems if enabled and type is not VANILLA
            ...
            // Fallback to vanilla if MMOItem not found (but type was not explicitly VANILLA)
            try {
                Material mat = Material.matchMaterial(id.toUpperCase());
                if (mat != null) {
                    mmoItem = new ItemStack(mat, amount);
